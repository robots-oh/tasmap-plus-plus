...
def mask_graph_construction(scene_points, frame_list, dataset, mask_visible_threshold, contained_threshold, undersegment_filter_threshold):
    '''
    ...
    boundary_points, point_in_mask_matrix, mask_point_clouds, point_frame_matrix, global_frame_mask_list = build_point_in_mask_matrix(scene_points, frame_list, dataset)
    visible_frames, contained_masks, undersegment_mask_ids = process_masks(frame_list, global_frame_mask_list, point_in_mask_matrix, boundary_points, mask_point_clouds, mask_visible_threshold, contained_threshold, undersegment_filter_threshold)
...
def build_point_in_mask_matrix(scene_points, frame_list, dataset):
    '''
...
def process_one_mask(point_in_mask_matrix, boundary_points, mask_point_cloud, frame_list, global_frame_mask_list, mask_visible_threshold, contained_threshold, undersegment_filter_threshold):
    '''
    ...
    for frame_id in possibly_visible_frames:
        ...
        if 1 - invisible_ratio < mask_visible_threshold and (np.sum(mask_id_count) - mask_id_count[0]) < 500:
            continue
        visible_num += 1
        mask_id_count[0] = 0
...
def process_masks(frame_list, global_frame_mask_list, point_in_mask_matrix, boundary_points, mask_point_clouds, mask_visible_threshold, contained_threshold, undersegment_filter_threshold):
    '''
    ...
    for frame_id, mask_id in iterator:
        valid, visible_frame, contained_mask = process_one_mask(point_in_mask_matrix, boundary_points, mask_point_clouds[f'{frame_id}_{mask_id}'], frame_list, global_frame_mask_list, mask_visible_threshold, contained_threshold, undersegment_filter_threshold)
